...
# Copyright (c) 2029 Xu Shaohua <shaohua@biofan.org>. All rights reserved.
...
def main():
    if not check_system("netbsd"):
        sys.exit(1)

    def handle_all_arch():
        template_file = "netbsd_call.rs"
        for arch_name in SUPPORTED_ARCHES:
            root_dir = "platform/netbsd-%s" % arch_name
