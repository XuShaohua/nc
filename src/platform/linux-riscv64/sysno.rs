...
pub const SYS_STATFS: Sysno = 43;
pub const SYS_FSTATFS: Sysno = 44;
pub const SYS_TRUNCATE: Sysno = 45;
pub const SYS_FTRUNCATE: Sysno = 46;
...
pub const SYS_SENDFILE: Sysno = 71;
...
pub const SYS_NEWFSTATAT: Sysno = 79;
pub const SYS_FSTAT: Sysno = 80;
...
pub const SYS_MMAP: Sysno = 222;
pub const SYS_FADVISE64: Sysno = 223;
...
pub const SYS_RISCV_HWPROBE: Sysno = 258;
pub const SYS_RISCV_FLUSH_ICACHE: Sysno = 259;
