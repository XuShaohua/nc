...
fn get_file_limit() {
    ...
    if ret.is_err() {
        ...
        println!("Limit of open files, current: {}, max: {}", res_limit.rlim_cur, res_limit.rlim_max);
    }
}
...
fn set_file_limit() {
    ...
    if ret.is_err() {
        ...
        println!("Update limit of open files, current: {}, max: {}", res_limit.rlim_cur, res_limit.rlim_max);
    }
}

fn main() {
    println!("Open /proc/{}/limits to see limits of current process!", nc::getpid());
    get_file_limit();
    set_file_limit();
    get_file_limit();
    let _= nc::pause();
